...
export default function App() {
  ...
  if(!lottieLoad){
    return (
      ...
      height: '100%', backgroundColor:"#FEE0E5",
      width: '100%',
      justifyContent: 'space-around', alignItems:'center'}}>
        <Text style={{fontSize:72, fontFamily:'IrishGrover', color:'black'}}>Alan Pucci</Text>
        <AnimatedLottieView  style={{width:350}}
          autoPlay 
          source={require('./assets/splash.json')}
        />
        <Text style={{fontSize:72, fontFamily:'IrishGrover',color:'black'}}>4ºB</Text>
      </View>)
  }
